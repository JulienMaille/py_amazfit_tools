...
class StressProgressElement(ContainerElement):
    def __init__(self, parameter, parent = None, name = None):
        ...
        super(StressProgressElement, self).__init__(parameters = None, parameter = parameter, parent = parent, name = name)

    def draw3(self, drawer, resources, state):
        maximal = 100 # Stress max 100: 0-39 - relax, 40-59 - normal, 60-70 Medium, 80-100 High
        import random
    ...
    def createChildForParameter(self, parameter):
        ...
        if parameterId == 1:
            ...
            print ("Unknown StressProgressElement",parameterId)
            return super(StressProgressElement, self).createChildForParameter(parameter)

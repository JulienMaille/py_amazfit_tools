...
class TimeDigitalElement(ContainerElement):
    def __init__(self, parameter, parent = None, name = None):
        ...
        self._hours_delimiter = None
        self._minutes_delimiter = None
    ...
    def draw3(self, drawer, images, state):
        ...
        if self._hours:
            followxy = self._hours.draw4(drawer, images, hours, 2, self._padding_zero_hours, suffix=self._hours_delimiter)
        ...
        if self._minutes:
            followxy = self._minutes.draw4(drawer,
                                           ...
                                           suffix = self._minutes_delimiter)
    ...
    def createChildForParameter(self, parameter):
        ...
        if parameterId == 1:
            ...
            self._hours_delimiter = parameter.getValue()
            return ValueElement(parameter, self, 'DelimiterHoursImageIndex')
        elif parameterId == 6:
            self._minutes_delimiter = parameter.getValue()
